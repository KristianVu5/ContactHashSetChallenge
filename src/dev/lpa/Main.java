...
public class Main {
    static void main(String[] args) {
        ...
        int idex = emails.indexOf(new Contact("Robin Hood"));
        Contact robinHood = emails.get(idex);
        ...
        printData("(A - B) Intersect emails (A) - phones (B)",AMinusB);

        Set<Contact> BMinusA = new HashSet<>(phoneContacts);
        BMinusA.removeAll(emailContacts);
        printData("(B - A) Intersect emails (B) - phones (A)",BMinusA);
